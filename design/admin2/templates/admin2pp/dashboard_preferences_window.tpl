{*
 * $Id: dashboard_preferences_window.tpl 64 2010-03-09 22:22:49Z dpobel $
 * $HeadURL: http://svn.projects.ez.no/admin2pp/trunk/extension/admin2pp/design/admin2/templates/admin2pp/dashboard_preferences_window.tpl $
 *}
{if is_set( $blocks )}
